...
public final class RandomDoubleDefinition
{
    private RandomDoubleDefinition() {}

    public static final List<String> TRANSFORMATIONS = List.of(
            Transformations.NEGATE.getName(),
            Transformations.ROUND.getName()
    );
    ...
    public static final List<FieldOption> OPTIONS = List.of(
            ...
            new FieldOption(OptionKey.OUTPUT_TYPE, DataTypeDuckDb.DOUBLE.name())
    );
