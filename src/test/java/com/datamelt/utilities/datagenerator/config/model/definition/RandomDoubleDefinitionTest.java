...
class RandomDoubleDefinitionTest extends AbstractDefinitionTest
{
    @Override
    protected FieldType getFieldType() { return FieldType.RANDOMDOUBLE; }
    ...
    {
        FieldProcessor processor = buildProcessorWithDefaults("double.field");
